<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AcercaDe.aspx.cs" Inherits="Biblioteca1.AcercaDe" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="Contac">
            <h2>Acerca De</h2>
            <p>
                Este es crud creado en en visual studio 2022, la base de datos es sql server, 
                este crud para llevar un gestion y el orden de los libros dentro de una biblioteca.
            </p>
        </div>
    </form>
</body>
